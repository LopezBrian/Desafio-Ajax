...
$("#jsonBtn").click(() => {
    $.getJSON(URLJSON, function (respuesta, estado) {
        ...
        console.log(estado);
        if (estado === "success") {
            let personaje = respuesta;
            

            for (const pj of personaje) {
                console.log(pj);
                $("body").append(`<div id="personaje2"><h2>Tu personaje:</h2>     
                <ul id="char_info">
                <li>Nombre: ${pj.nombre}</li>
                <li>Nivel: ${pj.nivel}</li>
                <li>Experiencia: ${pj.experiencia}</li>
                <li>Ataque: ${pj.ataque}</li>
                <li>Defensa: ${pj.defensa}</li>
                <li>Salud: ${pj.salud}</li>
                </ul></div>`)  
            }            
        }
    });
